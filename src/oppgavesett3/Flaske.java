...
public class Flaske {
	...
	/**
	 * @param kapasitet
	 *            Flaskens maksimumskapasitet, målt i liter
	 */
	...
	/**
	 * Metode som heller vann fra flasken som er gitt som parameter til denne
	 * flasken. Mengden vann som helles over fra den ene flasken til den andre
	 * er begrenset enten av kapasiteten til flasken som tar imot vannet eller
	 * vannmengden på flasken det helles fra.
	 * 
	 * @param fraFlaske
	 *            Flasken det helles fra.
	 */
	public void hellOver(Flaske fraFlaske) {
		if (ledigPlass() >= fraFlaske.hentVannmengde()) {
			...
			fraFlaske.reduserMengde(ledigPlass());
			fyllFull();
		}
	}
